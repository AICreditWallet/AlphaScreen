...
export default function Home() {
  ...
  const Navbar = () => (
    <nav className="fixed top-0 w-full z-[200] px-6 md:px-12 h-24 flex items-center justify-between bg-black/80 backdrop-blur-3xl border-b border-white/5 pointer-events-auto">
      <div className="flex items-center gap-3 cursor-pointer" onClick={() => setView("landing")}>
        <img src="/logo.png" alt="AlphaScreen Logo" className="w-10 h-10 object-contain shadow-[0_0_20px_#E50914] rounded-sm" />
        <div className="flex flex-col">
          <span className="text-xl md:text-2xl font-black tracking-tighter uppercase italic leading-none text-white">AlphaScreen</span>
          <span className="text-[8px] font-bold uppercase tracking-[0.2em] text-white/40 mt-1">AI autonomous movie generator</span>
        </div>
      </div>
  ...
  const LandingView = () => (
    <div className="relative min-h-screen flex flex-col items-center justify-center cinema-bg pt-40 md:pt-48">
      ...
      <motion.div 
        ...
        className="relative z-10 text-center space-y-8 px-6 max-w-4xl mx-auto mt-8"
      >
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter uppercase italic leading-tight text-gradient">
          Cinema <br />
        ...
        {showVision && (
          ...
          >
            ...
            <div className="w-full h-full relative overflow-hidden bg-black">
               ...
               <div className="absolute bottom-20 left-1/2 -translate-x-1/2 z-[310] text-center space-y-6 w-full px-6 pointer-events-none">
